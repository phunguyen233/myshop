...
export const addWarehouse = async (req, res) => {
  try {
    // Dữ liệu mong đợi: { don_vi_nhap, chi_tiet: [{ ma_san_pham, so_luong, don_gia_nhap }, ...] }
    ...
    for (const it of chi_tiet) {
      ...
      // Trigger DB `trg_tang_tonkho_sau_khi_nhap` sẽ cập nhật bảng `sanpham` và `lichsu_tonkho`
    }
